...
let mouthAmount = document.querySelectorAll('.pricing .price .mouth');
...
let slides = document.querySelectorAll('.reviews .slider-container .slider');
let index = 0;
